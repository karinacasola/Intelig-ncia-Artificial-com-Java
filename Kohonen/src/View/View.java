...
public class View extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPnAbrirArquivo.setBackground(new java.awt.Color(255, 255, 255));
        jPnAbrirArquivo.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel2.setText("Selecione dados para  treinamento:");
        ...
        jPnTreinamento.setBackground(new java.awt.Color(255, 255, 255));
        jPnTreinamento.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel4.setText("Selecione dados para teste:");
  ...
  private void abrirArquivoTreinamento() {
    ...
    if (pasta != null && nome != null) {
      ...
      jTxtArquivoDadosTreinamento.setText(arquivoTreinamento.getDiretorios());
  ...
  private void abrirArquivoTeste() {
    ...
    if (pasta != null && nome != null) {
      ...
      jTxtArquivoDadosTeste.setText(arquivoTeste.getDiretorios());
  ...
  private void acaoBotaoTreinar() {
    ...
    Emissor.setCampo(jTxtLogTreinamento);
    Emissor.adicionar_botoes(jBtnSalvarTreinamento, jBtnAbrirDadosTeste);
    treinarRede();
  }
  ...
  private void treinarRede() {
    ...
    redeKN = new KN();
    thread = new Threads(redeKN);
    thread.set_treinamento(arquivoTreinamento);
  ...
  private void testarRede() {
    ...
    if (redeKN != null) {
      Emissor.setCampo(jTxtLogTeste);
      jBtnSalvarTeste.setEnabled(false);
      redeKN.testar(arquivoTeste);
